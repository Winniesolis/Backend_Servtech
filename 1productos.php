...
<body>
    ...
    <section class="content">
        ...
        <a href="1productos.php"></i></a>
        <form action="1productos.php" method="POST"  class="form1" enctype="multipart/form-data">
            ...
            <table>
                ...
                <?php
                    ...
                    <tr>
                        ...
                        <td class="btn-table">
                            <button>Editat<i class="fas fa-edit"></i></button>
                            <button>Eliminar<i class="fas fa-trash-alt"></i></button>
                        </td>
                    </tr> 
                    <?php
                          }  
